...
<body>
    ...
    <nav class="sidebar">
        ...
        <ul>
            ...
            <li><a href="#" class="feat-btn">Proyectos<br> Iris Gonzalez<br><br><span class="first">&#x021D3; </span></a>
                <ul class="feat-show">
                    <li><a href="#">GESTOR DOCUMENTAL</a></li>
                    <li><a href="#">SIVADOE<br>Firma Digital</a></li>
                    <li><a href="#">ZIMBA<br>Nuevo Correo Electrónico</a></li>
                    <li><a href="#">README<br>Seguimiento de Proyectos</a></li>
                    <li><a href="#">CHAT en linea</a></li>
                </ul>
            </li>
    ...
    <h1 class="sombra3" style="color:aqua"><b>PROYECTOS</b></h1><br><br><br><br><br><br><br><br><br><br>
